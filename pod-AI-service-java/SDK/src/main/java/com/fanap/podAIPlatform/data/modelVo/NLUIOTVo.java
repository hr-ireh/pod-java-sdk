...
public class NLUIOTVo {
    ...
    public NLUIOTVo(Builder builder) {
        this.baseInfoVo = builder.getBaseInfoVo();
        this.text = builder.getText();
//            if (getBaseInfoVo().getServerType().equals(PRODUCTION))
        this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesProduction.NLU_IOT);
//            else
