...
public class GetFakeApplicationStateVo {
    ...
    public GetFakeApplicationStateVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetFakeApplicationStateVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.appId != null)
                return new GetFakeApplicationStateVo(this);
