...
public class GetApplicationByIdVo {
    ...
    public GetApplicationByIdVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetApplicationByIdVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.id != null)
                return new GetApplicationByIdVo(this);
