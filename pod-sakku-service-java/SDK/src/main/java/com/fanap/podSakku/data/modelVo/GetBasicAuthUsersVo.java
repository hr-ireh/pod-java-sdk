...
public class GetBasicAuthUsersVo {
    ...
    public GetBasicAuthUsersVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetBasicAuthUsersVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.appId != null)
                return new GetBasicAuthUsersVo(this);
