...
public class GetRealTimeDeployVo {
        ...
        public GetRealTimeDeployVo(Builder builder) {
        ...
        public static class Builder {
            ...
            public GetRealTimeDeployVo build() throws PodException {
                if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                        this.appId != null)
                    return new GetRealTimeDeployVo(this);
