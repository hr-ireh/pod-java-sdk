...
public class GetApplicationVersionsVo {
    ...
    public GetApplicationVersionsVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetApplicationVersionsVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.appId != null)
                return new GetApplicationVersionsVo(this);
