...
public class StopApplicationDeployVo {
    ...
    public StopApplicationDeployVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public StopApplicationDeployVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.appId != null)
                return new StopApplicationDeployVo(this);
