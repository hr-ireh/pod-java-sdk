...
public class GetAppHealthCheckVo {
    ...
    public GetAppHealthCheckVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetAppHealthCheckVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.id != null)
                return new GetAppHealthCheckVo(this);
