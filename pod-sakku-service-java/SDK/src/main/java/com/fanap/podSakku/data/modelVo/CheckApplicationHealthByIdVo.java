...
public class CheckApplicationHealthByIdVo {
    ...
    public CheckApplicationHealthByIdVo(Builder builder) {
    ...
    public static class Builder {
        ...
        public CheckApplicationHealthByIdVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                    this.id != null && this.hid != null)
                return new CheckApplicationHealthByIdVo(this);
