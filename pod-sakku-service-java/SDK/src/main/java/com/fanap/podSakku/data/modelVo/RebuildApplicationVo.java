...
public class RebuildApplicationVo {
        ...
        public RebuildApplicationVo(Builder builder) {
        ...
        public static class Builder {
            ...
            public RebuildApplicationVo build() throws PodException {
                if (this.baseInfoVo != null && this.baseInfoVo.getAuthorization() != null &&
                        this.appId != null)
                    return new RebuildApplicationVo(this);
