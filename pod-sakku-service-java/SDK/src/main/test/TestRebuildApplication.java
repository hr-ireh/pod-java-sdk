...
import com.fanap.podSakku.data.modelVo.RebuildApplicationVo;
...
public class TestRebuildApplication {
    private static String TOKEN = "";

    @Test
    public void rebuildApplication_AllParameters() {
    ...
    @Test
    public void rebuildApplication_NoParameters() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
        PodSakku podSakku = new PodSakku();
        try {
