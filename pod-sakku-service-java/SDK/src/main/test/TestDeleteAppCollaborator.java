...
import com.fanap.podSakku.data.modelVo.DeleteAppCollaboratorVo;
...
public class TestDeleteAppCollaborator {
    private static String TOKEN = "";

    @Test
    public void deleteAppCollaborator_AllParameters() {
        ...
        try {
            ...
            podSakku.deleteAppCollaborator(deleteAppCollaboratorVo, new OnGetResponseListener<String>() {
                ...
                public void onResponse(ResultVo<String> result) {
                    ...
                    try {
                        assertEquals("کاربر از برنامه حذف شد!", result.getResult());
    ...
    @Test
    public void deleteAppCollaborator_RequiredParameters_Cid() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setAuthorization(TOKEN)
                .build();
        PodSakku podSakku = new PodSakku();
    ...
    @Test
    public void deleteAppCollaborator_RequiredParameters_Id() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setAuthorization(TOKEN)
                .build();
        PodSakku podSakku = new PodSakku();
    ...
    @Test
    public void deleteAppCollaborator_NoParameters() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
        PodSakku podSakku = new PodSakku();
        try {
