...
import com.fanap.podSakku.data.modelVo.DeleteNetworkByUserVo;
...
public class TestDeleteNetworkByUser {
    private static String TOKEN = "";

    @Test
    public void deleteNetworkByUser_AllParameters() {
    ...
    @Test
    public void deleteNetworkByUser_RequiredParameters_Name() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setAuthorization(TOKEN)
                .build();
        PodSakku podSakku = new PodSakku();
    ...
    @Test
    public void deleteNetworkByUser_RequiredParameters_Force() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setAuthorization(TOKEN)
                .build();
        PodSakku podSakku = new PodSakku();
    ...
    @Test
    public void deleteNetworkByUser_NoParameters() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
        PodSakku podSakku = new PodSakku();
        try {
