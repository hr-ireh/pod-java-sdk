...
import com.fanap.podSakku.data.modelSrv.AppInfoSrv;
import com.fanap.podSakku.data.modelVo.BaseInfoVo;
import com.fanap.podSakku.data.modelVo.GetApplicationSettingVo;
...
public class TestGetApplicationSetting {
    private static String TOKEN = "";

    @Test
    public void getApplicationSetting_AllParameters() {
        ...
        try {
            ...
            podSakku.getApplicationSetting(getApplicationSettingVo, new OnGetResponseListener<AppInfoSrv>() {
                ...
                public void onResponse(ResultVo<AppInfoSrv> result) {
                    ...
                    try {
                        assertEquals(2338, result.getResult().getId());
    ...
    @Test
    public void getApplicationSetting_NoParameters() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
        PodSakku podSakku = new PodSakku();
        try {
