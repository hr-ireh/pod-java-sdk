...
import com.fanap.podSakku.data.modelVo.CreateCatalogAppBySakkuAppVo;
...
public class TestCreateCatalogAppBySakkuAppVo {
    private static String TOKEN = "";

    @Test
    public void createCatalogAppBySakkuApp_AllParameters() {
    ...
    @Test
    public void createCatalogAppBySakkuApp_RequiredParameters_CatalogId() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setAuthorization(TOKEN)
                .build();
        PodSakku podSakku = new PodSakku();
    ...
    @Test
    public void createCatalogAppBySakkuApp_RequiredParameters_AddCatalogAppVO() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setAuthorization(TOKEN)
                .build();
        PodSakku podSakku = new PodSakku();
    ...
    @Test
    public void createCatalogAppBySakkuApp_NoParameters() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
        PodSakku podSakku = new PodSakku();
        try {
