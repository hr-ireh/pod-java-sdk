...
public class GetAccountBillAsFileVo {
    ...
    private final static String REQUIRED_PARAMETER_ERROR_MESSAGE = "Token, token_issuer, serverType, dateTo or dateFrome are required parameters!";
    ...
    public GetAccountBillAsFileVo(Builder builder) {
        ...
        this.lastNRows = builder.getLastNRows();
    ...
    public static class Builder {
        ...
        public Builder setLastNRows(String lastNRows) {
