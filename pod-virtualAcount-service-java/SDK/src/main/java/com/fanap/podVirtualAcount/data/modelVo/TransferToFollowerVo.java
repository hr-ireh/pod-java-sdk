...
public class TransferToFollowerVo {
    ...
    public TransferToFollowerVo(Builder builder) {
        ...
        if (getBaseInfoVo().getServerType().equals(PRODUCTION))
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesProduction.NZH_BIZ_TRANSFER_TO_FOLLOWER);
        else
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesSandBox.NZH_BIZ_TRANSFER_TO_FOLLOWER);
    ...
    public static class Builder {
        ...
        public TransferToFollowerVo build() throws PodException {
