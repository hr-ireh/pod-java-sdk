...
public class TransferToFollowerListVo {
    ...
    public TransferToFollowerListVo(Builder builder) {
        ...
        if (getBaseInfoVo().getServerType().equals(PRODUCTION))
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesProduction.NZH_BIZ_TRANSFER_TO_FOLLOWER_LIST);
        else
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesSandBox.NZH_BIZ_TRANSFER_TO_FOLLOWER_LIST);
    ...
    public static class Builder {
        ...
        public TransferToFollowerListVo build() throws PodException {
