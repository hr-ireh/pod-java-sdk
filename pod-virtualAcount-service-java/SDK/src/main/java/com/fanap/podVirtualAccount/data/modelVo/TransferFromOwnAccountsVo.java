...
public class TransferFromOwnAccountsVo {
    ...
    private final static String REQUIRED_PARAMETER_ERROR_MESSAGE = "Token, token_issuer, guildAmount, customerAmount and serverType are required parameters!";
    ...
    public static class Builder {
        ...
        public TransferFromOwnAccountsVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getToken() != null &&
                    ...
                    this.guildAmount != null && this.customerAmount != null)
