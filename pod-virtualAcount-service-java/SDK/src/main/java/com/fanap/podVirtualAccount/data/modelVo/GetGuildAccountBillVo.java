...
public class GetGuildAccountBillVo {
    ...
    public GetGuildAccountBillVo(Builder builder) {
        ...
        if (getBaseInfoVo().getServerType().equals(PRODUCTION))
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesProduction.NZH_BIZ_GET_ACCOUNT_BILL);
        else
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesSandBox.NZH_BIZ_GET_ACCOUNT_BILL);
    ...
    public static class Builder {
        ...
        public GetGuildAccountBillVo build() throws PodException {
