...
public class WithdrawRuleUsageReportVo {
    ...
    public WithdrawRuleUsageReportVo(Builder builder) {
        this.baseInfoVo = builder.getBaseInfoVo();
        this.ruleId = TypeConversionUtil.longToString(builder.getRuleId());
        if (getBaseInfoVo().getServerType().equals(PRODUCTION))
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesProduction.WITH_DRAW_RULE_USAGE_REPORT);
        else
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesSandBox.WITH_DRAW_RULE_USAGE_REPORT);
    ...
    public static class Builder {
        ...
        public WithdrawRuleUsageReportVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getToken() != null &&
                    this.baseInfoVo.getToken_issuer() != null && this.baseInfoVo.getServerType() != null
                    && this.ruleId != null)
                return new WithdrawRuleUsageReportVo(this);
