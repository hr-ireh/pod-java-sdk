...
import com.fanap.podVirtualAccount.data.modelVo.GuildAmount;
import com.fanap.podVirtualAccount.data.modelVo.ResultVo;
import com.fanap.podVirtualAccount.data.modelVo.TransferFromOwnAccountsVo;
...
public class TestTransferFromOwnAccounts {
    private static String TOKEN = "";

    @Test
    public void transferFromOwnAccounts_AllParameters() {
...
//                .setScVoucherHash(scVoucherHashs)
        ...
        GuildAmount[] guildAmounts = {new GuildAmount("CLOTHING_GUILD", -100L), new GuildAmount("API_GUILD", -300L)};
//        List<String> scVoucherHashs=new ArrayList<>();
//        scVoucherHashs.add("ghjdshfjshf");
        try {
            TransferFromOwnAccountsVo transferFromOwnAccountsVo = new TransferFromOwnAccountsVo.Builder(baseInfoVo)
                    ...
                    .setCurrencyCode("IRR")
                    .setCustomerAmount(400L)
                    .setDescription("من ماندم تنهای تنها")
                    .setUniqueId((new Random(100000)).toString())
    ...
    @Test
    public void transferFromOwnAccounts_NoParameters() {
//        List<String> scVoucherHashs=new ArrayList<>();
//        scVoucherHashs.add("ghjdshfjshf");
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
