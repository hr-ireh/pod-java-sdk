...
import com.fanap.podProduct.data.modelVo.BusinessProductListVo;
...
public class TestBusinessProductList {


    @Test
    public void getBusinessProductList_RequiredParameters() {
    ...
    @Test
    public void getBusinessProductList_AllParameters() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken("2b02de2188a149bfa74b7760d4a64c85")
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
...
//                .setScVoucherHash(scVoucherHashs)
    ...
    @Test
    public void getBusinessProductList_SomeRequiredParameters_Offset() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken("2b02de2188a149bfa74b7760d4a64c85")
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
    ...
    @Test
    public void getBusinessProductList_SomeRequiredParameters_Size() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken("2b02de2188a149bfa74b7760d4a64c85")
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
    ...
    @Test
    public void getBusinessProductList_NoParameters() {
