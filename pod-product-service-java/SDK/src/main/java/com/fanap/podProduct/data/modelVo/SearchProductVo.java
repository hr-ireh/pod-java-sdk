...
public class SearchProductVo {
    ...
    public SearchProductVo(Builder builder) {
        ...
        this.categoryCodes = builder.getCategoryCodes();
        ...
        this.orderByLike = builder.getOrderByLike();
        this.orderBySale = builder.getOrderBySale();
    ...
    public static class Builder {
        ...
        public Builder setCategoryCodes(List<String> categoryCodes) {
        ...
        public SearchProductVo build() throws PodException {
