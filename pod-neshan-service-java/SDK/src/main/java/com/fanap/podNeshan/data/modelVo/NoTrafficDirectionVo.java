...
public class NoTrafficDirectionVo {
    ...
    public NoTrafficDirectionVo(Builder builder) {
        this.baseInfoVo = builder.getBaseInfoVo();
        this.scProductId = TypeConversionUtil.intToString(NeshanProductId.NO_TRAFFIC_DIRECTION);
    ...
    public static class Builder {
        ...
        public NoTrafficDirectionVo build() throws PodException {
            if (this.baseInfoVo != null && this.baseInfoVo.getToken() != null &&
                    this.baseInfoVo.getToken_issuer() != null &&
                    this.baseInfoVo.getScApiKey() != null && this.origin != null && this.destination != null)
                return new NoTrafficDirectionVo(this);
