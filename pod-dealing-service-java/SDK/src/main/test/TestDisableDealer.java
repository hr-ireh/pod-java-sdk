...
import com.fanap.podDealing.data.modelVo.DisableDealerVo;
...
public class TestDisableDealer {
    @Test
//    @Order(1)
//    @DisplayName("")
    public void disableDealer_AllParameters1() {
...
//    @Order(1)
//    @DisplayName("")
    public void disableDealer_NoParameters1() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .build();
...
//    @Order(1)
//    @DisplayName("")
    public void disableDealer_SomeRequiredParameters_DealerBizId() {
        BaseInfoVo baseInfoVo = new BaseInfoVo.Builder()
                .setToken("1c0898d03cef4c0a80741653aaa1b8ad")
                .setToken_issuer(1)
                .setServerType(Enum_Server_type.SANDBOX)
