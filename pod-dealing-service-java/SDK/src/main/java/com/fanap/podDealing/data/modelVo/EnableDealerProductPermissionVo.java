...
public class EnableDealerProductPermissionVo {
    ...
    public EnableDealerProductPermissionVo(Builder builder) {
        ...
        if (getBaseInfoVo().getServerType().equals(PRODUCTION))
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesProduction.NZH_BIZ_ENABLE_DEALER_PRODUCT_PERMISSION);
        else
            this.scProductId = TypeConversionUtil.intToString(ScProductIdPodServicesSandBox.NZH_BIZ_ENABLE_DEALER_PRODUCT_PERMISSION);
